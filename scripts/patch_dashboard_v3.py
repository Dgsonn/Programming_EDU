#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Refactor dashboard v3: roadmap ở cột phải, mọi thứ còn lại dồn vào cột trái."""
import io
import re
...
def main():
    ...
    <div class="page active" id="page-dashboard">
      ...
      <div class="dash-grid">
        ...
        <!-- ── TRÁI 1/2: welcome + stats + calendar + BXH ── -->
        <div class="dash-col-left">

          <!-- Welcome + Stats (cùng hàng) -->
    ...
    new_src = new_src.replace(
        ...
        'href="{{ url_for(\'static\', filename=\'css/dashboard.css\') }}?v=24"',
    )

    with io.open(HTML, 'w', encoding='utf-8') as f:
        f.write(new_src)
    print('[OK] dashboard.html updated — roadmap ở cột phải, tất cả thứ khác dồn cột trái.')
